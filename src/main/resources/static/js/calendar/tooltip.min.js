...
(function (a, b) {
	...
	var c = function (a, b) {
		...
		placement: 'top',
		title: '',
		template: '<div class="tooltips" role="tooltips"><div class="tooltips-arrow"></div><div class="tooltips-inner"></div></div>',
		trigger: 'hover focus',
		offset: 0,
		arrowSelector: '.tooltips-arrow, .tooltips__arrow',
		innerSelector: '.tooltips-inner, .tooltips__inner'
	}, g = function () {
		function g(a, b) {
		...
		return d(g, [{
			key: '_create', value: function (a, b, c, d) {
				...
				f.id = 'tooltips_' + Math.random().toString(36).substr(2, 10), f.setAttribute('aria-hidden', 'false');
