...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <script>
        ...
        function doSearch() {
            ...
            store.load(baseUrl + '/DH1808/doSearch', function () {
                ...
                chart.makeHighChart_rCharts('highChart', chartObj, option);
    ...
    <e:window id="DH1808" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
