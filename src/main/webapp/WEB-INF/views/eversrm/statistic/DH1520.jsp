...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        var baseUrl = "/eversrm/statistic/DH1520"
           ,grid;
        ...
        function init() {
            ...
            if(${_gridType eq "RG"}) {
                grid.setColGroup([{
                    "groupName": '${DH1520_MSG_PUR_AMT}',
                    "columns": [ "PUR_AMT", "PUR_RATE" ]
                }, {
                    "groupName": '${DH1520_MSG_CM_AMT}',
                    "columns": [ "CM_PART_AMT", "CM_RAW_AMT" ]
                }, {
                    "groupName": '${DH1520_MSG_PURE_PUR_AMT}',
                    "columns": [ "PURE_PUR_AMT", "PURE_PUR_RATE" ]
                }]);
            } else {
                grid.setGroupCol(
                      [
                        {'colName' : 'PUR_AMT',       'colIndex': 2, 'titleText' : '${DH1520_MSG_PUR_AMT}'},
                        {'colName' : 'CM_PART_AMT',   'colIndex': 2, 'titleText' : '${DH1520_MSG_CM_AMT}'},
                        {'colName' : 'PURE_PUR_AMT',  'colIndex': 2, 'titleText' : '${DH1520_MSG_PURE_PUR_AMT}'}
                      ]
                );
            }
        }
    ...
    <e:window id="DH1520" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
