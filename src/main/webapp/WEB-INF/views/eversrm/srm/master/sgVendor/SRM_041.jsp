...
<script>
    var baseUrl = "/eversrm/srm/master/sgVendor/";
    var gridV;
    var gridSG;
    var SelectRowId;
    var SelectGrid;
    ...
    function init() {
    	...
    	gridSG.cellClickEvent(function(rowid, colId, value) {
            ...
            case 'VENDOR_CD':
//	            var params = {
//	                VENDOR_CD: gridSG.getCellValue(rowid, "VENDOR_CD"),
//	                popupFlag  : true,
//	                detailView : true
//	            };
...
//	            everPopup.openSupManagementPopup(params);
    ...
    function doSearch() {
        ...
        store.load(baseUrl + "SRM_041/doSearch", function() {
        });
    }
    var delType ='sg';
    ...
    function doDelete() {
		...
		store.load(baseUrl + 'SRM_041/'+method+'', function() {
...
<e:window id="SRM_041" onReady="init" initData="${initData}" title="${fullScreenName}">
    ...
    <div id="e-tabs" class="e-tabs" style="padding: 0 !important;">
        <tr><td><div>
          <ul>
            <li id="tab1"><a href="#ui-tabs-1" onclick="getContentTab('1');">${SRM_041_SG}</a></li>
            <li id="tab2"><a href="#ui-tabs-2" onclick="getContentTab('2');">${SRM_041_VENDOR}</a></li>
          </ul>
