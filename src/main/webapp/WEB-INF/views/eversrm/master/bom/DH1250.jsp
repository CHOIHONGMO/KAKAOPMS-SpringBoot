...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + 'DH1250/doSearchBom', function() {
    ...
    <e:window id="DH1250" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" title="${form_CAPTION_N }" columnCount="2" labelWidth="${labelNarrowWidth }" onEnter="doSearch">
            <e:row>
                ...
                <e:field>
                    <e:search id="ITEM_NM" style="${imeMode}" name="ITEM_NM" value="" width="${inputTextWidth}" maxLength="${form_ITEM_NM_M}" onIconClick="${form_ITEM_NM_RO ? 'everCommon.blank' : 'doSearchItemCd'}" disabled="${form_ITEM_NM_D}" readOnly="${form_ITEM_NM_RO}" required="${form_ITEM_NM_R}" />
                    <e:inputHidden id="ITEM_CD" name="ITEM_CD" value="" />
