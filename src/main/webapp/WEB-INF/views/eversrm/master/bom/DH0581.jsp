...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
  ...
  <script>
    ...
    var grid;
    var baseUrl = "/eversrm/master/bom/DH0581";
    var selRow;
	var currrow;
...
//                  grid.setCellValue(rowId, 'REG_USER_NM', '${ses.userNm}');
    ...
    function selectVendor2(data) {
        grid.setCellValue(currrow,'FM_VENDOR_CD', data['VENDOR_CD'] );
        grid.setCellValue(currrow,'FM_VENDOR_NM', data['VENDOR_NM'] );
    }
    ...
    function searchITEM_CD() {
      ...
      function selectItemCd3(data) {
        	...
        	grid.setCellValue(currrow,'FM_ITEM_CD',data.ITEM_CD);
          	grid.setCellValue(currrow,'FM_ITEM_NM',data.ITEM_DESC);
      }


    </script>

  <e:window id="DH0581" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
    <e:searchPanel id="form" title="${msg.M9999}" columnCount="1" labelWidth="100" width="100%" useTitleBar="true" onEnter="doSearch">
      <e:row>
