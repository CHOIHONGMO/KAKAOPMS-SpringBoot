...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function search() {
        	...
        	store.setGrid([grid]);
            store.load(baseUrl + '/BSN_120/doSearch', function() {
        ...
        function delete2() {
        	...
        	store.load(baseUrl + '/BSN_120/doDelete', function(){
    ...
    <e:window id="BSN_120" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" title="${form_CAPTION_N }" labelWidth="${labelWidth}" width="100%" columnCount="2" onEnter="search">
           <e:row>
