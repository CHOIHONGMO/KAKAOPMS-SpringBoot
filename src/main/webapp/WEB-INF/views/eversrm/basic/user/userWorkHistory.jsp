...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <e:window id="BADU_030" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" title="${form_CAPTION_N }" labelWidth="${labelWidth}" width="100%" columnCount="3" onEnter="search" useTitleBar="false">
            ...
            <e:row>
                ...
                <e:field>
                    <e:inputText id="MODULE_NM" name="MODULE_NM"  readOnly="${form_MODULE_NM_RO }"  maxLength="${form_MODULE_NM_M}"  value="" width="${form_MODULE_NM_W }" required="${form_MODULE_NM_N }" disabled="${form_MODULE_NM_N }" />
                </e:field>
                <e:label for="METHOD_NM" title="${form_METHOD_NM_N }" />
                <e:field>
                    <e:inputText id="METHOD_NM" name="METHOD_NM"   readOnly="${form_METHOD_NM_RO }"   value=""  maxLength="${form_METHOD_NM_M}"  width="${form_METHOD_NM_W }" required="${form_METHOD_NM_R }" disabled="${form_METHOD_NM_D }" onFocus="onFocus" />
                </e:field>
            ...
            <e:row>
                ...
                <e:field>
                    <e:inputText id="SCREEN_ID" name="SCREEN_ID" readOnly="${form_SCREEN_ID_RO }"  value=""  maxLength="${form_SCREEN_ID_M}"  width="${form_SCREEN_ID_W }" required="${form_SCREEN_ID_R }" disabled="${form_SCREEN_ID_D }" onFocus="onFocus" />
                </e:field>
                <e:label for="ACTION_CD" title="${form_ACTION_CD_N }" />
                <e:field>
                    <e:inputText id="ACTION_CD" name="ACTION_CD"  readOnly="${form_ACTION_CD_RO }"   value=""  maxLength="${form_ACTION_CD_M}"   width="${form_ACTION_CD_W }" required="${form_ACTION_CD_N }" disabled="${form_ACTION_CD_N }" />
                </e:field>
                <e:label for="FAIL_TYPE" title="${form_FAIL_TYPE_N}"/>
                <e:field>
                    <e:select id="FAIL_TYPE" name="FAIL_TYPE" value="" options="${failTypeOptions}" width="${form_FAIL_TYPE_W}" disabled="${form_FAIL_TYPE_D}" readOnly="${form_FAIL_TYPE_RO}" required="${form_FAIL_TYPE_R}" placeHolder="" />
                </e:field>
            </e:row>
        </e:searchPanel>
