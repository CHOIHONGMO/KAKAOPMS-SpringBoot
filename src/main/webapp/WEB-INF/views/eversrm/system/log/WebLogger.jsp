...
<div style="border-radius: 2px; line-height: 20px; background-color: #ccc; color: #000; font-size: 12px; text-indent: -1px; width: 80px; height: 23px; text-align: center; margin-top: 4px; cursor: pointer;" onclick="location.href='/WebLogger/view';">새로고침</div>
${path}
</body>
</html>