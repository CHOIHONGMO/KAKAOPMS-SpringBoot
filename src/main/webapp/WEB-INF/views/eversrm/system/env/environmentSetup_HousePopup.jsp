...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
    	...
    	function doSearch() {
        	...
        	store.setGrid([grid]);
            store.load(baseUrl + 'environmentSetup_HousePopup/doSearchHouse', function() {
    ...
    <e:window id="BSA_211" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
<%--         <e:searchPanel id="form" title="${form_CAPTION_N }" columnCount="2" labelWidth="${labelWidth }">
        </e:searchPanel> --%>
