...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
    	...
    	function doSearch() {
        	...
        	store.setGrid([grid]);
            store.load(baseUrl + 'environmentSetup_CompanyPopup/doSearchCompany', function() {
    ...
    <e:window id="BSA_212" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
