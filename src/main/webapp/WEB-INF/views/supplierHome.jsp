...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <title>(주)카카오페이증권 - 공급사 ${ses.userNm}님 환영합니다.</title>
    ...
    <e:window id="e-body" width="100%" height="100%" onReady="init" initData="${initData}" padding="0 0 0 0">
        <div id="contentsBody" class="ui-layout-center" style="width: 100%;">
            <div id="e-main-tab" class="e-main-tab" style="height: 100%; width: 100%;">
                ...
                <iframe id="ui-tabs-main" src="/eversrm/mypageSupplier/view" frameborder="0" scrolling="auto" marginheight="0" marginwidth="0" width="100%" height="100%" src="" style="padding: 0; margin: 0; height: 100%; width: 100%;"></iframe>
            </div>
        </div>
	    ...
	    <script>
	        ...
	        $(document).ready(function() {
	            ...
	            if("${supplierIrsSameIdYN}"=="Y") {
	                alert("새로운관리자를 생성하십시오.\n사업자 번호와 같은 아이디는 사용안함 처리 바랍니다.\n일정기간이후 사업자번호와 동일한 아이디는 삭제됩니다.");
	                openScreenToNewTab("TM901295","회사/사용자 정보","/siis/M03/M03_003/view","");
	        ...
	        function openScreenToNewTab(id, text, value, e, data) {
	            ...
	            store.load('/common/util/' + 'menuClickSave', function () {
	                if(this.getResponseCode() == '1') {
	                    ...
	                    var $tabLabel = $('<li id="ui-tabs-label-' + id + '" title="' + text + '"><a href="#ui-tabs-' + id + '" style="width: 80px; padding-right: 0px;">' + text + '</a> <span class="ui-icon ui-icon-close" role="presentation">X</span></li>').hide();
