...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "im01050_doSearch", function () {
        ...
        function doSave() {
            ...
            store.load(baseUrl + "im01050_doSave", function () {
        ...
        function doDelete() {
            ...
            store.setGrid([grid]);
            store.getGridData(grid, 'sel');
            store.load(baseUrl + "im01050_doDelete", function () {
                alert(this.getResponseMessage());
                doSearch();
            });
        }
    ...
    <e:window id="IM01_050" onReady="init" initData="${initData}" title="${fullScreenName}">
