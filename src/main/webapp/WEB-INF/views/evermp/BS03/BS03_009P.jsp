...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <script type="text/javascript">
        ...
        function init() {
            ...
            grid.cellClickEvent(function(rowId, colId, value) {
                ...
                if(colId == 'EV_RESULT_SCORE') {
                    var param = {
                        VENDOR_CD: grid.getCellValue(rowId, 'VENDOR_CD'),
                        SEQ: grid.getCellValue(rowId, 'SEQ'),
                        detailView: true
                    };
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + 'BS03_009P_doSearch', function() {
    ...
    <e:window id="BS03_009P" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
