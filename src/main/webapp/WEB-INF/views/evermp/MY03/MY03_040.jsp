...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    function doSearch() {
        ...
        store.setGrid([grid]);
        store.load(baseUrl + 'my03040_doSearch', function() {
    ...
    <e:window id="MY03_040" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		<e:searchPanel id="form" onEnter="doSearch" title="${msg.M9999}" labelWidth="${labelWidth}" width="100%" columnCount="3" useTitleBar="false">
            <e:row>
				...
				<e:field>
					...
					<e:inputText id="BUYER_NAME" name="BUYER_NAME" value="" width="60%" maxLength="${form_BUYER_NAME_M}" disabled="${form_BUYER_NAME_D}" readOnly="${form_BUYER_NAME_RO}" required="${form_BUYER_NAME_R}" />
				</e:field>
				...
				<e:field>
					...
					<e:inputText id="VENDOR_NAME" name="VENDOR_NAME" value="" width="60%" maxLength="${form_VENDOR_NAME_M}" disabled="${form_VENDOR_NAME_D}" readOnly="${form_VENDOR_NAME_RO}" required="${form_VENDOR_NAME_R}" />
				</e:field>
			</e:row>
            <e:row>
