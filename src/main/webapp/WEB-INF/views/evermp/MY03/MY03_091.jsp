...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    function doSearch() {
        ...
        store.setGrid([grid]);
        store.load(baseUrl + 'my03091_doSearch', function() {
    ...
    */
    ...
    <e:window id="MY03_091" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
...
<%--				<e:label for="DATE_SEL" title="${MY03_091_001}" />--%>
<%--				<e:field>--%>
...
<%--						<e:radio id="DATE_SEL_D" name="DATE_SEL_D" value="D" label="${MY03_091_002}" disabled="false" readOnly="false" />--%>
<%--						<e:radio id="DATE_SEL_W" name="DATE_SEL_W" value="W" label="${MY03_091_003}" disabled="false" readOnly="false" />--%>
<%--						<e:radio id="DATE_SEL_B" name="DATE_SEL_B" value="B" label="${MY03_091_004}" disabled="false" readOnly="false" />--%>
<%--						<e:radio id="DATE_SEL_M" name="DATE_SEL_M" value="M" label="${MY03_091_005}" disabled="false" readOnly="false" checked="true" />--%>
<%--&lt;%&ndash;						<e:radio id="DATE_SEL_S" name="DATE_SEL_S" value="S" label="${MY03_091_006}" disabled="false" readOnly="false" />&ndash;%&gt;--%>
<%--					</e:radioGroup>--%>
<%--				</e:field>--%>
			</e:row>
            <e:row>
