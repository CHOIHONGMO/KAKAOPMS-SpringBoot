...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    function doSearch() {
        ...
        store.setGrid([grid]);
        store.load(baseUrl + 'my03095_doSearch', function() {
        	if(grid.getRowCount() == 0){
				...
				var SUM_SALE_PLAN_RATE = {
					...
					text: "0",
					expression: ["sum['BEFORE_CPO_AMT'] / sum['SUM_SALE_PLAN_AMT'] * 100"],
					groupExpression: "sum"
				};
    ...
    <e:window id="MY03_095" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		<e:searchPanel id="form" onEnter="doSearch" title="${msg.M9999}" labelWidth="${labelWidth}" width="100%" columnCount="2" useTitleBar="false">
            <e:row>
				...
				<e:label for="DATE_SEL" title="${MY03_095_001}" />
				<e:field>
					<e:radioGroup id="DATE_SEL" name="DATE_SEL" value="" onClick="clickDateSel" width="130px" disabled="false" readOnly="false" required="false">
						<e:radio id="DATE_SEL_D" name="DATE_SEL_D" value="D" label="${MY03_095_002}" disabled="false" readOnly="false" />
						<e:radio id="DATE_SEL_W" name="DATE_SEL_W" value="W" label="${MY03_095_003}" disabled="false" readOnly="false" />
						<e:radio id="DATE_SEL_B" name="DATE_SEL_B" value="B" label="${MY03_095_004}" disabled="false" readOnly="false" />
						<e:radio id="DATE_SEL_M" name="DATE_SEL_M" value="M" label="${MY03_095_005}" disabled="false" readOnly="false" checked="true" />
<%--						<e:radio id="DATE_SEL_S" name="DATE_SEL_S" value="S" label="${MY03_095_006}" disabled="false" readOnly="false" />--%>
					</e:radioGroup>
				</e:field>
			</e:row>
            <e:row>
