...
/*            grid.setColMerge(["CUST_NM", "DEPT_NM", "CPO_USER_NM", "REF_MNG_NO", "CPO_NO", "CPO_SEQ", "PO_NO", "PO_SEQ", "CUST_ITEM_CD", "ITEM_CD", "ITEM_DESC", "ITEM_SPEC",
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "sgr1010_doSearch", function () {
        ...
        function onSearchPlant() {
            if( EVF.V("CUST_CD") == "" ) return alert("${SGR1_010_002}");
            var param = {
    ...
    <e:window id="SGR1_010" onReady="init" initData="${initData}" title="${fullScreenName}">
            ...
            <e:row>
                <e:label for="START_DATE">
                    <e:select id="START_DATE_COMBO" name="START_DATE_COMBO" width="99" disabled="false" readOnly="false" required="false" usePlaceHolder="false">
                        <e:option text="${SGR1_010_010}" value="CPO_DATE"/>
                        <e:option text="${SGR1_010_011}" value="HOPE_DUE_DATE"/>
                    </e:select>
                </e:label>
                <e:field>
