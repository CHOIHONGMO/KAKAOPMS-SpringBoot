...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        ...
        var grid;
        var baseUrl = "/evermp/STO/STO04_060/";
        var RowId = 0;
        ...
        function doSearch(){
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "sto0406_doSearch", function () {
    ...
    <e:window id="STO04_060" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
