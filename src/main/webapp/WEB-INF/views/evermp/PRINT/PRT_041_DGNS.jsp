    ...
    <script>
        ...
        $(document).ready(function () {
            for (var i in printData) {
                ...
                html += "        <div class=\"title\">" + '거 래 명 세 서' + "</div>\n";
                ...
                html += "                    <td class=\"header_text\" colspan=\"3\">" + hd.V_AC_RECIPIENT_ADDRESS + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr>\n";
                ...
                for (var j in printHd) {
                    ...
                    html += "                    <td class=\"left   no_bb\">" + (dt.V_GRID_ITEM_DESC== null ? '' :dt.V_GRID_ITEM_DESC) + "</td>\n";
                    ...
                    html += "                    <td class=\"left   no_bb\" rowspan=\"2\">" + (dt.V_GRID_MAKER_NAME == null ? '' : dt.V_GRID_MAKER_NAME) + "</td>\n";
                    html += "                </tr>\n";
                    html += "                <tr>\n";
                ...
                html += "                    <col class=\"left\"   width=\"210\">\n";
                html += "                    <col class=\"center\" width=\"82\">  <!-- 납품희망일 -->\n";
                html += "                    <col class=\"left\"   width=\"136\">\n";
                ...
                html += "                    <td>" + (hd.V_AC_DELY_APP_DATE == null ? '' :hd.V_AC_DELY_APP_DATE) + "</td>\n";
                html += "                    <td class=\"header_title\">" + hd.AC_HOPE_DUE_DATE + "</td>\n";
                html += "                    <td colspan=\"3\">" + (hd.V_AC_HOPE_DUE_DATE == null ? '' :hd.V_AC_HOPE_DUE_DATE) + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"10\">\n";
                ...
                html += "                    <col class=\"center\" width=\"43\">  <!-- 부서명 -->\n";
                html += "                    <col class=\"left\"   width=\"80\">\n";
                html += "                    <col class=\"center\" width=\"81\">  <!-- 연락처 -->\n";
                html += "                    <col class=\"left\"   width=\"297\">\n";
                ...
                html += "                    <td class=\"header_title\">" + hd.AC_CONFIRMATION + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"15\">\n";
                ...
                html += "                    <td colspan=\"5\">지연사유 : " + (hd.DELY_DELAY_NM == null ? '' : hd.DELY_DELAY_NM) + "<br>" + (hd.DELY_DELAY_REASON == null ? '' : hd.DELY_DELAY_REASON) + "</td>\n";
                html += "                </tr>\n";
                html += "            </table>\n";
                html += "        </div>\n";
                html += "</div>\n";
