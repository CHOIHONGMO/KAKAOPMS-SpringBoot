    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            for (var i in printData) {
                ...
                html += "                   <p class='header_table_r'>"+ hd.CEO_NAME +"&nbsp;&nbsp;"+ hd.V_CEO_NM +"</p>\n";
                html += "                   <p class='space'>\n";
                ...
                html += "            <span class='text_title' style=\"color:red;font-weight:bold; font-size:11px;\"></span>\n";
                ...
                for (var j in printHd) {
                    ...
                    html += "                    <td class=\"right  no_bb\" rowspan=\"2\">" + dt.DT_UNIT_PRC + "</td>\n";
                    html += "                    <td class=\"right   no_bb\" rowspan=\"2\">" + dt.DT_ITEM_PRC + "</td>\n";
                    html += "                    <td class=\"center   no_bb\" rowspan=\"2\">" + dt.MAKER_NM + " / " + dt.MODEL_NM +"</td>\n";
                    html += "                </tr>\n";
                    html += "                <tr>\n";
                    html += "                    <td class=\"left  no_bb\" colspan=\"2\">" + dt.DT_ITEM_SPEC + "</td>\n";
                    html += "                    <td class=\"center no_bb\">" + dt.DT_ITEM_QTY + "</td>\n";
                    html += "                </tr>\n";
                }
