        ...
        $(document).ready(function () {
            for (var i in printData) {
                ...
                if ('${param.invType}' == 'C') {
                    ...
                    html += "        <div class=\"title\">" + hd.HEADER_CAPTION1 + "</div>\n";
                }
                //html += "        <div class=\"logo\"><img alt=\"\" src=\"" + hd.IMAGE_PATH + "\" style=\"width: 150px; height: auto;\"></div>\n";
                html += "        <br>\n";
...
//        			html += "                   <div class=\"sign\"><img class=\"signImg\" alt=\"\" src=\"/images/kakao/common/bizneworks_company_sign.png\"></div>\n";
                ...
                html += "            <span class='text_title' style=\"color:red;font-weight:bold\">" + hd.HEADER_CPO_NO + " : " + hd.V_VO_NO + "</span>\n";
...
//                    html += "                    <th rowspan=\"2\">" + hd.GRID_VENDOR_ITEM_CD + "</th>\n";
                ...
                for (var j in printHd) {
                    var dt = printHd[j];
                    html += "                <tr>\n";
                    html += "                    <td class=\"center no_bb\" rowspan=\"2\">" + dt.V_GRID_ITEM_NO + "</td>\n";
                    html += "                    <td class=\"center no_bb\" rowspan=\"2\">" + dt.V_GRID_ITEM_CODE + "</td>\n";
                    html += "                    <td class=\"left   no_bb\">" + dt.V_GRID_ITEM_DESC + "</td>\n";
                    html += "                    <td class=\"center no_bb\" rowspan=\"2\">" + dt.V_GRID_UNIT_MEASURE + "</td>\n";
                    html += "                    <td class=\"right  no_bb\">" + dt.V_GRID_CPO_QTY + "</td>\n";
                    html += "                    <td class=\"right  no_bb\" rowspan=\"2\">" + dt.V_GRID_INV_QTY + "</td>\n";
                    html += "                    <td class=\"right  no_bb\" rowspan=\"2\">&nbsp;</td>\n";
                    if ('${param.invType}' != 'C') {
                        html += "                    <td class=\"right  no_bb\" rowspan=\"2\">&nbsp;</td>\n";
                    } else {
//                        html += "                    <td class=\"right  no_bb\" rowspan=\"2\">&nbsp;</td>\n";
//                        html += "                    <td class=\"left  no_bb\" rowspan=\"2\">" + dt.V_GRID_VENDOR_ITEM_CD + "</td>\n";
                    }
                ...
                html += "                    <td width=\"372\" style=\"font-weight: bold;text-align: right\">&nbsp;</td>\n";
                html += "                </tr>\n";
                html += "            </table>\n";
                html += "        </div>\n";
                html += "\n";
                ...
                html += "                <colgroup>\n";
                html += "                    <col class=\"center\" width=\"99\">  <!-- 납품일자 -->\n";
                html += "                    <col class=\"left\"   width=\"190\">\n";
                html += "                    <col class=\"center\" width=\"82\">  <!-- 납품희망일 -->\n";
                html += "                    <col class=\"left\"   width=\"156\">\n";
                html += "                    <col class=\"center\" width=\"82\">  <!-- 연락처 -->\n";
                html += "                    <col class=\"left\"   width=\"165\">\n";
                html += "                </colgroup>\n";
                html += "                <tr height=\"10\">\n";
                html += "                    <td class=\"center\" style=\"font-weight: bold;background-color: #dff8ff;\" colspan=\"6\">납품처 정보</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"10\">\n";
                html += "                    <td class=\"header_title\">" + hd.AC_DELY_APP_DATE + "</td>\n";
                html += "                    <td>" + hd.V_AC_DELY_APP_DATE + "</td>\n";
                html += "                    <td class=\"header_title\">" + hd.AC_HOPE_DUE_DATE + "</td>\n";
                if ('${param.invType}' != 'C') {
                    html += "                    <td colspan=\"3\">" + hd.V_AC_HOPE_DUE_DATE + "</td>\n";
                } else {
                    html += "                    <td>" + hd.V_AC_HOPE_DUE_DATE + "</td>\n";
                    html += "                    <td class=\"header_title\">" + hd.AC_VENDOR_NM + "</td>\n";
                    html += "                    <td>" + hd.O_VENDOR_NAME + "</td>\n";
                }
                html += "                </tr>\n";
                html += "                <tr height=\"10\">\n";
                html += "                    <td class=\"header_title\">주문자명</td>\n";
                html += "                    <td>" + (hd.V_CPO_USER_NM == null ? '' : hd.V_CPO_USER_NM) + "</td>\n";
                html += "                    <td class=\"header_title\">부서명</td>\n";
                html += "                    <td>" + (hd.V_CPO_USER_DEPT_NM == null ? '' : hd.V_CPO_USER_DEPT_NM) + "</td>\n";
                html += "                    <td class=\"header_title\">연락처</td>\n";
                html += "                    <td>" + (hd.V_CPO_USER_TEL_NUM == null ? '' : hd.V_CPO_USER_TEL_NUM)+ " (" + (hd.V_CPO_USER_CELL_NUM == null ?  '' : hd.V_CPO_USER_CELL_NUM)  + ")</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"20\">\n";
                html += "                    <td class=\"header_title\">" + hd.AC_RECIPIENT_ADDRESS + "</td>\n";
                html += "                    <td colspan=\"5\">" + (hd.V_AC_BOTTOM_RECIPIENT_ADDRESS == null ? '' :hd.V_AC_BOTTOM_RECIPIENT_ADDRESS ) + "</td>\n";
                html += "                </tr>\n";
                html += "            </table>\n";
                html += "            \n";
                html += "            <!-- 인수자 정보 -->\n";
                html += "            <span style=\"font-size: 10px;color: red;float: right; line-height:25px\">" + hd.AC_CAPTION + "&nbsp;&nbsp;</span><br>\n";
                html += "            <table class=\"footer_table\" width=\"100%\" border=\"1\" style=\"float: left; height: 100px;\">\n";
                html += "                <colgroup>\n";
                html += "                    <col class=\"center\" width=\"96\">  <!-- 인수자명 -->\n";
                html += "                    <col class=\"left\"   width=\"80\">\n";
                html += "                    <col class=\"center\" width=\"81\">  <!-- 부서명 -->\n";
                html += "                    <col class=\"left\"   width=\"130\">\n";
                html += "                    <col class=\"center\" width=\"81\">  <!-- 연락처 -->\n";
                html += "                    <col class=\"left\"   width=\"209\">\n";
                html += "                    <col class=\"center\" width=\"72\">  <!-- 인수자서명 -->\n";
                html += "                </colgroup>\n";
                html += "                <tr height=\"15\">\n";
                html += "                    <td class=\"header_title\">" + hd.AC_RECIPIENT_NAME + "</td>\n";
                html += "                    <td>" + (hd.V_AC_RECIPIENT_NAME == null ? '' : hd.V_AC_RECIPIENT_NAME) + "</td>\n";
                html += "                    <td class=\"header_title\">" + hd.AC_RECIPIENT_DEPT_NAME + "</td>\n";
                html += "                    <td>" + (hd.V_AC_RECIPIENT_DEPT_NAME == null ? '' : hd.V_AC_RECIPIENT_DEPT_NAME) + "</td>\n";
                html += "                    <td class=\"header_title\">" + hd.AC_RECIPIENT_TEL_NO + "</td>\n";
                html += "                    <td>" + (hd.V_AC_RECIPIENT_TEL_NO == null ? '' : hd.V_AC_RECIPIENT_TEL_NO) + " (" + (hd.V_AC_RECIPIENT_CELL_NO == null ? '' : hd.V_AC_RECIPIENT_CELL_NO) + ")</td>\n";
                html += "                    <td class=\"header_title\">" + (hd.AC_CONFIRMATION == null ? '' : hd.AC_CONFIRMATION) + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"15\">\n";
                html += "                    <td class=\"header_title\">" + hd.AC_RECIPIENT_DATE + "</td>\n";
                html += "                    <td colspan=\"5\">&nbsp;</td>\n";
                html += "                    <td align=\"center\" rowspan=\"2\">" + hd.AC_SIGNATURE + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr height=\"15\">\n";
                html += "                    <td class=\"header_title\">" + hd.AC_REMARK + "</td>\n";
                if ('${hd.DELY_DELAY_NM}' == '') {
//                	html += "                    <td colspan=\"5\">" + hd.DELY_DELAY_NM + "<br>" + hd.DELY_DELAY_REASON + "</td>\n";
                	html += "                    <td colspan=\"5\"></td>\n";
                } else {
                	html += "                    <td colspan=\"5\"></td>\n";
//                	html += "                    <td colspan=\"5\">지연사유 : " + hd.DELY_DELAY_NM + "<br>" + hd.DELY_DELAY_REASON + "</td>\n";
                }
                html += "                </tr>\n";
                html += "            </table>\n";
                html += "            \n";
                ...
                html += "                <tr>\n";
                html += "                    <td style=\"text-align: center; font-size: 10px;\">" + hd.FT_TEXT + "</td>\n";
                html += "                </tr>\n";
                html += "                <tr>\n";
                html += "                    <td style=\"text-align: center; font-size: 10px;\">Page : " + hd.CURRENT_PAGE + " / " + hd.TOTAL_PAGE + "</td>\n";
                html += "                </tr>\n";
                html += "            </table>\n";
                html += "        </div>\n";
                html += "</div>\n";
...
<!-- 화면 LOAD시 프린트 <body onLoad="window.print();">-->
<body onLoad="">
<div id="view">
