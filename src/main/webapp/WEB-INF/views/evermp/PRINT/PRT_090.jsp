    ...
    <script>
        ...
        $(document).ready(function () {
            for (var i in printData) {
                ...
                html += "                    <td class=\"header_text\" colspan=\"3\">" + hd.V_BUYER_NAME +"("+(hd.V_CUBL_NAME == null ? '-' : hd.V_CUBL_NAME)+ ")</td>\n";
                html += "                </tr>\n";
                html += "                <tr class=\"center\">\n";
                ...
                html += "                    <th rowspan=\"2\">" + '고객사상품코드<BR>상풍코드' + "</th>\n";
...
//                html += "                    <th>" + hd.GRID_RES_QTY + "</th>\n";
                ...
                for (var j in printHd) {
                    ...
                    html += "                    <td class=\"center no_bb\" rowspan=\"2\">" + (dt.V_GRID_ITEM_CODE ==null ? '' :dt.V_GRID_ITEM_CODE) + '<br>' + (dt.ITEM_CD == null ? '' : dt.ITEM_CD)+"</td>\n";
