...
//                html += "   <div class=\"logo\"><img alt=\"\" src=\"/images/kakao/common/(주)대명소노시즌_logo.png\" style=\"width: 150px; height: auto;\"></div>\n";
                ...
                html += "               <!-- 1. 발신자 -->\n";
                html += "               <div id=\"left\">\n";
                html += "                   <p class='header_table_l'>"+ hd.RECV +" : "+ hd.CUST_NM +"</p>\n";
                ...
                html += "                   <p class='space'>\n";
                html += "                   <p class='top_header_title'>"+ hd.TEL_NO +" : "+ hd.O_TEL_NUM +"</p>\n";
                html += "                   <p class='top_header_title'>"+ hd.FAX_NO +" : "+ hd.O_FAX_NUM +"</p>\n";
//                html += "                   <p class='top_header_title'>"+ hd.USER_NM +" : "+ hd.O_DEPT_NM + " " + hd.O_USER_NM + " " + hd.O_POSITION_NM+"</p>\n";
                html += "                   <p class='top_header_title'>"+ hd.USER_NM +" :  " + hd.O_USER_NM + " " + hd.O_POSITION_NM+"</p>\n";
                html += "                   <p class='top_header_title'>"+ hd.EMAIL +" : "+ hd.O_EMAIL +"</p>\n";
                html += "                   <p class='top_header_title'>"+ hd.HEADER_ISSUE_DATE +" : "+ hd.ISSUE_DATE +"</p>\n";
                html += "               </div>\n";
                html += "               <div id=\"right\">\n";
                html += "               <!-- 2. 수신자 -->\n";
                html += "                   <p class='header_table_r'>"+ hd.SEND +" : "+ hd.BUYER_NM +"</p>\n";
                html += "                   <p class='header_table_r'>"+ hd.V_ADDR +"</p>\n";
                ...
                html += "                   <p class='top_header_title2'>"+ hd.TEL_NO +" : "+ hd.V_TEL_NUM +"</p>\n";
                html += "                   <p class='top_header_title2'>"+ hd.FAX_NO +" : "+ hd.O_FAX_NUM +"</p>\n";
                html += "                   <p class='top_header_title2'>"+ hd.USER_NM +" : "+ (hd.V_DEPT_NM == null ? '' :hd.V_DEPT_NM)+ " " + hd.V_USER_NM + " " + hd.V_POSITION_NM+"</p>\n";
                html += "                   <p class='top_header_title2'>"+ hd.EMAIL +" : "+ hd.V_EMAIL +"</p>\n";
                html += "                   </div>\n";
