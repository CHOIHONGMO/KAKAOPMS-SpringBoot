...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        ...
        function doSearchDefault() {
            ...
            store.setGrid([gridL]);
            store.load(baseUrl + "rq01013_doSearchDefault", function() {
        ...
        function changeVendorTplno() {
        	doSearchDefault();
        }

    </script>

    <e:window id="RQ01_013" onReady="init" initData="${initData}" title="${fullScreenName}">
        <e:searchPanel id="form1" title="${msg.M9999 }" columnCount="1" labelWidth="135" onEnter="doSearch" useTitleBar="false">
            ...
            <e:row>
			<e:label for="TPL_NO" title="${form_TPL_NO_N}"/>
			<e:field>
				<e:select id="TPL_NO" name="TPL_NO" value="" options="${tplNoOptions}" width="${form_TPL_NO_W}" disabled="${form_TPL_NO_D}" readOnly="${form_TPL_NO_RO}" required="${form_TPL_NO_R}" placeHolder=""  onChange="changeVendorTplno" />
			</e:field>
			</e:row>
        </e:searchPanel>
