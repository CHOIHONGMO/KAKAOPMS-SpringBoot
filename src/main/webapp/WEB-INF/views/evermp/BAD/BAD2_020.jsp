...
<script>
    ...
    function init() {
         ...
         // 주문번호
        	...
        	if(colId == "CPO_ITEM_AMT") {
                param = {
                         ...
                         CPO_DEPT_CD: grid.getCellValue(rowId, "CPO_DEPT_CD"),
                         CPO_DEPT_NM: grid.getCellValue(rowId, "CPO_DEPT_NM"),
                         ...
                         DOC_NUM: grid.getCellValue(rowId, "CPO_NO"),
                         CPO_USER_ID: grid.getCellValue(rowId, "CPO_USER_ID"),
                         CPO_USER_NM: grid.getCellValue(rowId, "HID_CPO_USER_NM")
 					};
        ...
        grid.setColGroup([{
            "groupName": "${BAD2_020_007}",
            "columns": [ "CPO_DEPT_CD", "CPO_DEPT_NM", "CPO_USER_ID", "CPO_USER_NM", "CPO_CNT", "CPO_QTY", "CPO_ITEM_AMT", "STD_ITEM_AMT" ]
        }],55);
    ...
    function doSearch() {
        ...
        store.setGrid([grid]);
        store.load(baseUrl + 'bad2020_doSearch', function() {
        	if(grid.getRowCount() == 0){
                ...
                grid.setRowFooter("CPO_DEPT_NM", footerTxt);
    ...
    <e:window id="BAD2_020" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		<e:searchPanel id="form" onEnter="doSearch" title="${msg.M9999}" labelWidth="${labelWidth}" width="100%" columnCount="2" useTitleBar="false">
            <e:row>
				...
				<e:label for="CPO_DATE_SEL" title="${BAD2_020_001}" />
				<e:field>
					<e:radioGroup id="CPO_DATE_SEL" name="CPO_DATE_SEL" value="" onClick="clickCPO_DATE_SEL" width="${form_CUST_CONFIRM_YN_W}" disabled="false" readOnly="false" required="false">
						<e:radio id="CPO_DATE_SEL_D" name="CPO_DATE_SEL_D" value="D" label="${BAD2_020_002}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_W" name="CPO_DATE_SEL_W" value="W" label="${BAD2_020_003}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_B" name="CPO_DATE_SEL_B" value="B" label="${BAD2_020_004}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_M" name="CPO_DATE_SEL_M" value="M" label="${BAD2_020_005}" disabled="false" readOnly="false" checked="true" />
						<e:radio id="CPO_DATE_SEL_S" name="CPO_DATE_SEL_S" value="S" label="${BAD2_020_006}" disabled="false" readOnly="false" />
					</e:radioGroup>
				</e:field>
			</e:row>
            <e:row>
				...
				<e:field>
					<e:search id="DEPT_CD" name="DEPT_CD" value="" width="40%" maxLength="${form_DEPT_CD_M}" onIconClick="searchCustDeptCd" disabled="${form_DEPT_CD_D}" readOnly="${form_DEPT_CD_RO}" required="${form_DEPT_CD_R}" />
