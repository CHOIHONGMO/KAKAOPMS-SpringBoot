...
<script>
    ...
    function init() {
        ...
        grid.setColGroup([{
            "groupName": "${BAD2_010_007}",
            "columns": [ "CPO_CNT", "CPO_QTY", "CPO_ITEM_AMT", "STD_ITEM_AMT" ]
        }],55);
    ...
    function doSearch() {
        ...
        store.setGrid([grid]);
        store.load(baseUrl + 'bad2010_doSearch', function() {
    ...
    <e:window id="BAD2_010" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		<e:searchPanel id="form" onEnter="doSearch" title="${msg.M9999}" labelWidth="${labelWidth}" width="100%" columnCount="2" useTitleBar="false">
            <e:row>
				...
				<e:label for="CPO_DATE_SEL" title="${BAD2_010_001}" />
				<e:field>
					<e:radioGroup id="CPO_DATE_SEL" name="CPO_DATE_SEL" value="" onClick="clickCPO_DATE_SEL" width="${form_CUST_CONFIRM_YN_W}" disabled="false" readOnly="false" required="false">
						<e:radio id="CPO_DATE_SEL_D" name="CPO_DATE_SEL_D" value="D" label="${BAD2_010_002}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_W" name="CPO_DATE_SEL_W" value="W" label="${BAD2_010_003}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_B" name="CPO_DATE_SEL_B" value="B" label="${BAD2_010_004}" disabled="false" readOnly="false" />
						<e:radio id="CPO_DATE_SEL_M" name="CPO_DATE_SEL_M" value="M" label="${BAD2_010_005}" disabled="false" readOnly="false" checked="true" />
						<e:radio id="CPO_DATE_SEL_S" name="CPO_DATE_SEL_S" value="S" label="${BAD2_010_006}" disabled="false" readOnly="false" />
					</e:radioGroup>
				</e:field>
			</e:row>
            <e:row>
