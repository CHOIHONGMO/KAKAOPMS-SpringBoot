...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	<script>
	    var baseUrl = "/evermp/buyer/rq/RQ0340P03";
	    var grid;

	    function init() {
			$(".e-title-text").after('<div style="color:red; font-size: 11pt;">&nbsp;&nbsp;&nbsp;견적비교표는 업체 선정 후에 확인이 가능합니다.</div>');
			...
			<c:forEach varStatus="status" var="columnx" items="${additionalColumn}" >
		    	...
		    	//grid.setColDecimal('${columnx.COLUMN_ID}',4);
		   // gridV.createColumn('COLUMN_ID','dj',100,'center','text',50,false,false,'',0)
			</c:forEach>
...
//	        }
	...
	<e:window id="RQ0340P03" onReady="init" initData="${initData}" width="100%" height="100%" name="${fullScreenName}" title="${fullScreenName}">

        <e:searchPanel id="form" title="견적비교" labelWidth="150" labelAlign="${labelAlign}" columnCount="2" onEnter="doSearch">
