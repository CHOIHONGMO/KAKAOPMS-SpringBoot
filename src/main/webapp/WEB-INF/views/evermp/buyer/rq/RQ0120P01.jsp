...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	<script>
	    var baseUrl = "/evermp/buyer/rq/RQ0120P01";
	    function init() {
	...
	<e:window id="RQ0120P01" onReady="init" initData="${initData}" width="100%" height="100%" name="${fullScreenName}" title="${fullScreenName}">
        <e:searchPanel id="form" title="${form_CAPTION_N}" labelWidth="${labelWidth}" labelAlign="${labelAlign}" columnCount="1" onEnter="">
        	...
        	<e:inputHidden id="RFX_TO_DATE" name="RFX_TO_DATE" value="${form.RFX_TO_DATE}"/>
            <e:row>
				<%--시작일자--%>
            ...
            <e:row>
				...
				<e:field>
				<e:textArea height="250" width="100%" disabled="false" maxLength="4000" required="false" id="FROM_MOD_RMK" readOnly="${param.detailView}" name="FROM_MOD_RMK" value="${param.TEXT_CONTENTS }"/>
				</e:field>
            </e:row>
        </e:searchPanel>
