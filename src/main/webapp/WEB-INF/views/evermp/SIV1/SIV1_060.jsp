...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "siv1060_doSearch", function () {
    ...
    <e:window id="SIV1_060" onReady="init" initData="${initData}" title="${fullScreenName}">
            ...
            <e:row>
                <e:label for="START_DATE">
                    <e:select id="START_DATE_COMBO" name="START_DATE_COMBO" width="99" disabled="false" readOnly="false" required="false" usePlaceHolder="false">
                        <e:option text="${SIV1_060_002}" value="AR_DATE"/>
                        <e:option text="${SIV1_060_003}" value="AP_DATE"/>
                        <e:option text="${SIV1_060_004}" value="CPO_DATE"/>
                        <e:option text="${SIV1_060_005}" value="GR_DATE"/>
                    </e:select>
                </e:label>
                <e:field>
