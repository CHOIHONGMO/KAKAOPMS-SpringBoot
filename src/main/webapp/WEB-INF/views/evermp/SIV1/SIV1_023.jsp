...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <e:window id="SIV_023" onReady="init" initData="${initData}" title="${not empty param.title ? param.title : screenName}" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" title="${form_CAPTION_N}" labelWidth="${labelWidth}" labelAlign="${labelAlign}" columnCount="1" useTitleBar="false">
	        ...
	        <e:row>
				...
				<e:field>
					<e:select id="CODE" name="CODE" value="${param.CODE}" options="${codeOptions}" width="100%" disabled="${form_CODE_D}" readOnly="${form_CODE_RO}" required="${form_CODE_R}" placeHolder="" usePlaceHolder="false" />
				</e:field>
	        </e:row>
	        <e:row>
