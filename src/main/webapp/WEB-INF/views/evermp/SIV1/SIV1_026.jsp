...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <e:window id="SIV1_026" onReady="init" initData="${initData}" title="${fullScreenName}">
        <e:searchPanel id="form" title="${form_CAPTION_N}" labelWidth="${labelWidth}" labelAlign="${labelAlign}" columnCount="2" useTitleBar="false">
            ...
            <e:row>
				<e:label for="DELY_RMK" title="${form_DELY_RMK_N}"/>
				<e:field colSpan="3">
					<e:textArea id="DELY_RMK" name="DELY_RMK" value="${formData.DELY_RMK }" height="100px" width="${form_DELY_RMK_W}" maxLength="${form_DELY_RMK_M}" disabled="${form_DELY_RMK_D}" readOnly="${form_DELY_RMK_RO}" required="${form_DELY_RMK_R}" />
				</e:field>
            </e:row>
        </e:searchPanel>
    </e:window>
