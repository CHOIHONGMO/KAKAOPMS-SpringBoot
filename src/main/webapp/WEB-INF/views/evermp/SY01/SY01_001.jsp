...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <e:window id="SY01_001" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		...
		<e:panel id="rightPanelB" height="385" width="49%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${SY01_001_LV4}</e:text>
        ...
        <e:panel id="leftPanel" height="385px" width="50%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${SY01_001_LV1}</e:text>
        ...
        <e:panel id="rightPanel" height="fit" width="49%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${SY01_001_LV2}</e:text>
        ...
        <e:panel id="leftPanelB" height="fit" width="50%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${SY01_001_LV3}</e:text>
