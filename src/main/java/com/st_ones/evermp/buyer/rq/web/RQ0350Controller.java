...
public class RQ0350Controller extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/RQ0350/view")
	public String RQ0350(EverHttpRequest req) throws Exception{
		...
		return "/evermp/buyer/rq/RQ0350";
	}

	@RequestMapping(value="/RQ0350/doSearch")
	public void doSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception{
		Map<String, String> formData=req.getFormData();
		formData.put("RQ_COMPLETION",req.getParameter("RQ_COMPLETION"));
		resp.setGridObject("grid", rq0300service.getSettleItemList(formData));
	}
