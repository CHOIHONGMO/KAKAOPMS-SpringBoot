...
public class CT0430Controller  extends BaseController {


    private static Logger logger = LoggerFactory.getLogger(CT0430Controller.class);
    ...
    @RequestMapping(value = "/CT0430/view")
    public String CT0430(EverHttpRequest req) throws Exception {
        ...
        return "/evermp/buyer/cont/CT0430";
    }

	@RequestMapping(value = "/CT0430/doSearch")
	public void formManagementDoSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception {
		resp.setGridObject("grid", ct0400service.getContPoDetailList(req.getFormData()));
	}
