...
public class CT0360Controller  extends BaseController {


    private static Logger logger = LoggerFactory.getLogger(CT0360Controller.class);
    ...
    @RequestMapping(value = "/CT0360/view")
    public String contractStatus(EverHttpRequest req) throws Exception {
        ...
        return "/evermp/buyer/cont/CT0360";
    }

    @RequestMapping(value = "/CT0360/doSearch")
    public void ecoa0020_doSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        ...
        resp.setGridObject("grid", ct0300service.etcContSearch(param));
    }

    @RequestMapping(value="/CT0360/doSave")
    public void saveETcInfo(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        List<Map<String, Object>> gridData = req.getGridData("grid");

        ct0300service.saveETcInfo(gridData);
        resp.setResponseMessage(messageService.getMessage("0031"));
    }

	public void ecoa0020_doSearch(Map<String, String> dataInfo1) {
