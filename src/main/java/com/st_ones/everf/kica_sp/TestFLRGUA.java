...
public class TestFLRGUA extends HttpServlet {
    ...
    public void setProc() {
		...
		SGIxLinker xLinker = new SGIxLinker("D:/app/mro/wiseconfig/KICA_SGIxLinker/conf/sendinfo1.properties", "send_jsp", true);
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		/* 보증서(증권) */
		String bond_numb_text ="333334444455555666667777788888";					/*	[선택]	  보증서(증권)번호           */
		/* 보증내용 */
...
//				FileWriteUtil.genFileCreate( "D:/DMMRO/workspace/mro/servlet_src/kica_sp/sampleFLRGUA.xml", xmlDoc);
				FileWriteUtil.genFileCreate( "D:/app/mro/servlet_src/kica_sp/sampleFLRGUA.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
