package com.st_ones.batch.comPlantIf.web;

import com.st_ones.batch.EverJob;
import com.st_ones.batch.batchLogCom.service.BatchLogCommon_Service;
import com.st_ones.batch.comPlantIf.service.ComPlantIf_Service;
...
@Service
public class ComPlantJob extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private ComPlantIf_Service comPlantIf_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            comPlantIf_service = SpringContextUtil.getBean(ComPlantIf_Service.class);
            
            String msg = "";
            int totalCount = 0;
            try {
                msg = comPlantIf_service.ComPlantIf(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "ComPlantIf");
                    logData.put("JOB_NM", "고객사 사업장 I/F");
                    logData.put("JOB_KEY", "");
