 ...
 */
@Service
public class CurDelyAlarmIf extends EverJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            try {
                // 금일 납품 알림
                msg = delyAlarmIfService.doAlarmCurInvoiceInfo(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "CurDelyInvoiceIf");
                    logData.put("JOB_NM", "금일 납품 알림(운영사 품목담당자 => 공급사 납품담당자)");
                    logData.put("JOB_KEY", "");
