package com.st_ones.batch.custUnitPrcIF.web;

import com.st_ones.batch.EverJob;
import com.st_ones.batch.batchLogCom.service.BatchLogCommon_Service;
import com.st_ones.batch.custUnitPrcIF.service.CustUnitPrcIF_Service;
 ...
 */
@Service
public class CustUnitPrcIF extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private CustUnitPrcIF_Service custUnitPrcIF_Service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            custUnitPrcIF_Service  = SpringContextUtil.getBean(CustUnitPrcIF_Service.class);

            String msg = "";
            int totalCount = 0;
            try {
                msg = custUnitPrcIF_Service.CustUnitPrcIF(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "CustUnitPrcIF");
                    logData.put("JOB_NM", "고객사 판가 I/F");
                    logData.put("JOB_KEY", "");
