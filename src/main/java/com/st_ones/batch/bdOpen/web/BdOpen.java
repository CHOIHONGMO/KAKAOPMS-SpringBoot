 ...
 */
@Service
public class BdOpen extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private BdOpen_Service bdopenService;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            bdopenService  = SpringContextUtil.getBean(BdOpen_Service.class);

            String msg = "";
            int totalCount = 0;
            try {
                msg = bdopenService.sendSmsBdOpen(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "BD_OPEN");
                    logData.put("JOB_NM", "입찰 개찰요청 SMS");
                    logData.put("JOB_KEY", "");
