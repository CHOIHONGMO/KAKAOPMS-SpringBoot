package com.st_ones.batch.comDivisionIf.web;

import com.st_ones.batch.EverJob;
import com.st_ones.batch.batchLogCom.service.BatchLogCommon_Service;
import com.st_ones.batch.comDivisionIf.service.ComDivisionIf_Service;
...
@Service
public class ComDivisionJob extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private ComDivisionIf_Service comDivisionIf_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            comDivisionIf_service = SpringContextUtil.getBean(ComDivisionIf_Service.class);
            
            String msg = "";
            int totalCount = 0;
            try {
                msg = comDivisionIf_service.ComDivisionIf(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "ComDivisionIf");
                    logData.put("JOB_NM", "고객사 사업부 I/F");
                    logData.put("JOB_KEY", "");
