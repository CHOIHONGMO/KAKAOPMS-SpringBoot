package com.st_ones.batch.gwApprovalIf.web;

import com.st_ones.batch.EverJob;
import com.st_ones.batch.batchLogCom.service.BatchLogCommon_Service;
import com.st_ones.batch.gwApprovalIf.service.GwApprovalIF_Service;
 ...
 */
@Service
public class GwApprovalIF extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private GwApprovalIF_Service approvalif_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            approvalif_service = SpringContextUtil.getBean(GwApprovalIF_Service.class);

            String msg = "";
            int totalCount = 0;
            try {
                msg = approvalif_service.GwApprovalIF(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "GWAPPROVAL_IF");
                    logData.put("JOB_NM", "GW 결재승인 I/F");
                    logData.put("JOB_KEY", "");
