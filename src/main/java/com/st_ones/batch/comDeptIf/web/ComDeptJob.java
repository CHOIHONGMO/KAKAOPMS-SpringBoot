package com.st_ones.batch.comDeptIf.web;

import com.st_ones.batch.EverJob;
import com.st_ones.batch.batchLogCom.service.BatchLogCommon_Service;
import com.st_ones.batch.comDeptIf.service.ComDeptIf_Service;
...
@Service
public class ComDeptJob extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private ComDeptIf_Service comDeptIf_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            comDeptIf_service = SpringContextUtil.getBean(ComDeptIf_Service.class);
            
            String msg = "";
            int totalCount = 0;
            try {
                msg = comDeptIf_service.ComDeptIf(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "ComDeptIf");
                    logData.put("JOB_NM", "고객사 부서 I/F");
                    logData.put("JOB_KEY", "");
