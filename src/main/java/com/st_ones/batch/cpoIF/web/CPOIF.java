 ...
 */
@Service
public class CPOIF extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private CPOIF_Service cpoif_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            cpoif_service = SpringContextUtil.getBean(CPOIF_Service.class);

            String msg = "";
            int totalCount = 0;
            try {
                msg = cpoif_service.CPOIF(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "CPO_IF");
                    logData.put("JOB_NM", "고객사주문 I/F");
                    logData.put("JOB_KEY", "");
