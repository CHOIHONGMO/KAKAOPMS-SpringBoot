 ...
 */
@Service
public class GRIF extends EverJob {

	@Autowired private BatchLogCommon_Service batchLogCommon_Service;
    @Autowired private GRIF_Service grif_service;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            grif_service = SpringContextUtil.getBean(GRIF_Service.class);

            String msg = "";
            int totalCount = 0;
            try {
                msg = grif_service.GRIF(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
                ...
                try {
                    ...
                    logData.put("JOB_ID", "GR_IF");
                    logData.put("JOB_NM", "입고 I/F");
                    logData.put("JOB_KEY", "");
