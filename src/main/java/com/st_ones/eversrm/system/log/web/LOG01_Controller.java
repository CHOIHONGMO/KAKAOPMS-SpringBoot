package com.st_ones.eversrm.system.log.web;
...
@Controller
@RequestMapping("/eversrm/system/log")
public class LOG01_Controller extends BaseController {

    @Autowired
    private DataSource dataSource;

    @RequestMapping("/LOG01_010/view")
    public String watcher(EverHttpRequest req) throws Exception {
        ...
        return "/eversrm/system/log/LOG01_010";
    }
}
